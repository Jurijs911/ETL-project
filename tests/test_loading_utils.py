...
class Test_Dim_Design:
    def test_read_inserted_data(self):
        ...
        Raises:
            InputValidationError:
            If the design_data is not in the expected format or contains
            invalid values.
        """
...
class Test_Dim_Staff:
    def test_read_inserted_dim_staff_data(self):
        ...
        Raises:
            InputValidationError:
            If the staff_data is not in the expected format or contains
            invalid values.
        """
...
class Test_Dim_Location:
    def test_insert_into_dim_location(self):
        ...
        Raises:
            InputValidationError:
            If the location_data is not in the expected format or contains
            invalid values.
        """
...
class Test_Dim_Date:
    def test_insert_into_dim_date_invalid_input(self):
        ...
        Raises:
            InputValidationError:
            If the date_data is not in the expected format or contains
            invalid values.
        """
...
class Test_Fact_Sales_Order:
    def test_insert_into_dim_fact_sales_order(self):
        ...
        Raises:
            InputValidationError:
            If the sales_data is not in the expected format
