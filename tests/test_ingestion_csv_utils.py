...
class Test_add_csv:
    ...
    def test_overwites_previous_csv_file(self):
        ...
        conn.put_object(Bucket="test_bucket", Key="currency/add.csv")
...
class Test_update_csv:
    ...
    def test_uploads_csv_to_object_in_bucket(self):
        ...
        conn.put_object(Bucket="test_bucket", Key="currency/update.csv")
